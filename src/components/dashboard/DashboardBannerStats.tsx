...
export function DashboardBannerStats({ workspace }: DashboardBannerStatsProps) {
  ...
  const vividClass = vivid ? "mobile-vivid-stat-pill" : "";

  return (
    <div className={`flex shrink-0 flex-row items-center gap-3 sm:gap-4 ${vivid ? "max-[639px]:w-full" : ""}`}>
      <div
        className={`group flex items-center gap-3 rounded-xl border border-orange-200/70 bg-white/70 px-4 py-3 backdrop-blur-md transition-all duration-300 ease-in-out hover:border-orange-400/50 dark:border-white/5 dark:bg-[#13131A]/40 dark:hover:border-orange-500/20 ${vividClass} mobile-vivid-orange ${vivid ? "max-[639px]:flex-1 max-[639px]:justify-center" : ""}`}
      >
        <span
      ...
      <div
        className={`group flex items-center gap-3 rounded-xl border border-cyan-200/70 bg-white/70 px-4 py-3 backdrop-blur-md transition-all duration-300 ease-in-out hover:border-cyan-400/50 dark:border-white/5 dark:bg-[#13131A]/40 dark:hover:border-cyan-500/20 ${vividClass} mobile-vivid-cyan ${vivid ? "max-[639px]:flex-1 max-[639px]:justify-center" : ""}`}
      >
        <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-cyan-500/15 text-cyan-600 transition-transform duration-300 group-hover:scale-110 dark:text-cyan-400 mobile-vivid-stat-icon">
