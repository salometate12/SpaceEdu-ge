  ...
  return (
    <section className="dashboard-section p-5">
      <div id="abit-library" className="mb-4 scroll-mt-24">
        <BookOpen className="mb-2 h-6 w-6 text-sky-600 dark:text-sky-400" strokeWidth={1.5} />
          ...
          return (
            <button
              ...
              className={`rounded-xl px-4 py-1.5 text-xs transition-all ${
                active
                  ? "bg-gradient-to-r from-pink-600 to-pink-500 text-white shadow-md shadow-pink-200/50 dark:from-pink-600 dark:to-pink-500 dark:shadow-pink-500/10"
                  : "border border-slate-200/80 bg-white text-slate-600 hover:border-sky-200 hover:text-sky-700 dark:border-white/[0.08] dark:bg-[#161619]/60 dark:text-gray-400 dark:hover:text-white"
              }`}
            >
              {filter.label}
            </button>
        ...
        {filtered.map((book) => (
          <DashboardMorphItem key={book.id} id={`abit-book-${book.id}`}>
            ...
            >
              {isLive ? (
                <>
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-slate-200/80 bg-gradient-to-br from-sky-50 via-white to-indigo-50 dark:border-white/[0.04] dark:bg-[#1a1a1e]/40">
                    <FileText className="h-5 w-5 text-sky-600 dark:text-sky-400" strokeWidth={1.5} />
                  </div>
                  <div className="min-w-0 flex-1">
                    <p className="text-xs font-medium text-sky-600 dark:text-sky-400/80">{book.subject}</p>
                ...
                <>
                  <div>
                    <div className="mb-3 flex h-28 w-full items-center justify-center rounded-xl border border-slate-200/80 bg-gradient-to-br from-sky-50 via-white to-indigo-50 transition-all group-hover:from-sky-100 group-hover:to-indigo-100 dark:border-white/[0.04] dark:bg-none dark:bg-[#1a1a1e]/40 dark:group-hover:bg-[#1a1a1e]/70">
                      <FileText className="h-7 w-7 text-sky-600 dark:text-sky-400" strokeWidth={1.5} />
                    </div>
                    <p className="mb-1 text-xs font-medium text-sky-600 dark:text-sky-400/80">
                      {book.subject}
                    </p>
