...
import {
  geographyPaperLabel,
  pickRandomGeographyMcq,
  type GeographyMcqDraw,
...
export function GeographyMcqPractice() {
  const [draw, setDraw] = useState<GeographyMcqDraw | null>(() => pickRandomGeographyMcq());
  const [picked, setPicked] = useState<string | null>(null);
  const [streak, setStreak] = useState(0);

  const reroll = () => {
    setDraw(pickRandomGeographyMcq(draw?.question.id));
    setPicked(null);
  };
