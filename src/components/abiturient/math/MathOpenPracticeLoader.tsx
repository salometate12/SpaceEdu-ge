...
/** Client-only so the random problem is drawn without a hydration mismatch. */
const MathOpenPractice = dynamic(
  () => import("./MathOpenPractice").then((mod) => ({ default: mod.MathOpenPractice })),
  {
    ssr: false,
    loading: () => (
...
export function MathOpenPracticeLoader() {
  return <MathOpenPractice />;
}
