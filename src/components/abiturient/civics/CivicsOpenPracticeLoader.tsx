...
const CivicsOpenPractice = dynamic(
  () => import("./CivicsOpenPractice").then((mod) => ({ default: mod.CivicsOpenPractice })),
  {
    ssr: false,
    loading: () => (
...
export function CivicsOpenPracticeLoader() {
  return <CivicsOpenPractice />;
}
