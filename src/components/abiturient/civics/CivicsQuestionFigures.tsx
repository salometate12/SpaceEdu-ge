...
import type { CivicsFigure } from "@/data/civicsExamsData";

function FigureView({ figure }: { figure: CivicsFigure }) {
...
export function CivicsQuestionFigures({ figures }: { figures?: CivicsFigure[] }) {
