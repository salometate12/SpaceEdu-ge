...
function CorrectionSheet({
  ...
  return (
    <div
      className={`exam-paper-plain overflow-hidden border-2 border-slate-300 transition-opacity duration-300 dark:border-white/15 ${
    ...
    >
      <div className="flex items-center justify-between gap-2 border-b-2 border-dashed border-slate-400/60 px-4 py-2.5 dark:border-white/20">
        <span className="flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-widest text-slate-600 dark:text-slate-300">
        ...
        <main className="relative mx-auto w-full max-w-4xl px-4 py-6 sm:px-6 sm:py-8">
          ...
          >
            <div className="exam-paper-plain select-none overflow-hidden border-2 border-slate-300 dark:border-white/15">
              <div className="flex items-center justify-between gap-2 border-b-2 border-dashed border-slate-400/60 px-4 py-2.5 dark:border-white/20">
                <span className="truncate text-[11px] font-bold uppercase tracking-widest text-slate-600 dark:text-slate-300">
