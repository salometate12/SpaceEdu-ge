  ...
  return (
    ...
    >
      ...
      >
        ...
        <path
          fill={`url(#${gradientId})`}
          d="M12 2.5l1.45 4.46a1 1 0 00.76.63l4.64 1.34-3.55 3.05a1 1 0 00-.33 1.01L16.2 18l-4.2-2.2a1 1 0 00-.93 0L6.87 18l1.36-4.01a1 1 0 00-.33-1.01L4.35 8.93l4.64-1.34a1 1 0 00.76-.63L12 2.5z"
        />
        <path
          fill={`url(#${gradientId})`}
          opacity="0.85"
