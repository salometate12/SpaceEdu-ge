  ...
  return (
    <section className="dashboard-glass-card relative overflow-hidden rounded-[32px] p-6">
      <div className="relative flex items-start gap-4">
        <div className="relative flex h-20 w-20 shrink-0 items-center justify-center rounded-[24px] bg-[var(--accent-primary)] text-xl font-black text-white shadow-lg ring-4 ring-white dark:ring-[#16161f]">
          {user.initials}
        </div>
